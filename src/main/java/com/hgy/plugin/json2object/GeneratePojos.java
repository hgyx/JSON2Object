...
import com.hgy.plugin.text.Inflector;
...
class GeneratePojos {
    ...
    private final Map<String, JDefinedClass> mClassMap = new HashMap<>();
    private JType mDeferredClass;
    private JType mDeferredList;
    private FieldComparator mFieldComparator;
    private final Map<JDefinedClass, Set<FieldInfo>> mFieldMap = new HashMap<>();
    ...
    private void generate(JsonNode rootNode, String rootName, JPackage jPackage, boolean generateBuilders,
        ...
        for (JDefinedClass clazz : mClassMap.values()) {
            ...
            List<GeneratedField> fields =
                generateFields(clazz, mFieldMap.get(clazz), jPackage.owner(), generateBuilders, useMPrefix);
